...
public class Main44 {
    public static void main(String[] args) {
        ...
        AuthManager44 googleDotCom = new AuthManager44(); // 객체 생성
        System.out.printf("--- \uD83D\uDD12 회원 인증 시스템 ---%n");

        google: while (true) { // 무한 루프
            System.out.printf("%n1. 회원가입 | 2. 로그인 | 3. 비밀번호 변경 | 4. 회원 탈퇴 | 5. 시스템 종료%n선택: ");
            int choice;
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 3 -> { // 비번 바꾸기
                        ...
                        googleDotCom.changePassword(id, oldPw, newPw);
                    }
                    case 4 -> { // 탈퇴
                        System.out.print("아이디: ");
                        String id = sc.next();
                        System.out.print("비밀번호: ");
                        String password = sc.next();
                        googleDotCom.deleteUser(id, password);
                    }
                    case 5 -> { // 종료
