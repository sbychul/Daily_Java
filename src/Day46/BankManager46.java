...
// 45일차에서 진짜 매우 약간의 수정 그저 메서드 하나만 더해짐.
public class BankManager46 {
    private HashMap<String, Account46> bankDB = new HashMap<>();
    ...
    public void createAccount(String accNum, String ownerName) {
        ...
        bankDB.put(accNum, new Account46(accNum, ownerName, 0));
    ...
    public void transfer(String fromAcc, String toAcc, long amount) {
        ...
        Account46 from = bankDB.get(fromAcc);
        Account46 to = bankDB.get(toAcc);
